...
class AddNomineeWithOutCategory extends StatefulWidget {
  final File contestNomineeWithoutCategoryImage;

  AddNomineeWithOutCategory({Key key, this.contestNomineeWithoutCategoryImage}) : super(key: key);
...
class _AddNomineeWithOutCategory extends State<AddNomineeWithOutCategory> {
  Future saveContestToPreference({
    ...
    preferences.setString('Contest Category', contestCategory);
  }

  final _formKey = GlobalKey<FormState>();
  String _contestCategory;
  String _country;
        ...
        child: Container(
          ...
          child: Stack(
            ...
            children: <Widget>[
              ...
              Positioned.fill(
                  child: widget.contestNomineeWithoutCategoryImage != null
                      ? Image.file(
                          widget.contestNomineeWithoutCategoryImage,
                          fit: BoxFit.cover,
