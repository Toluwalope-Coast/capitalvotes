...
class _VoteCartScreenState extends State<VoteCartScreen> {
  ...
  Widget slctedContestantInfo() {
    ...
    double _imgContainerWidth = 160.0;
    double _imgContainerHeight = 240.0;
    double _imgContainerRadius = 12.0;
        ...
        Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(_slctedContestantDesc, style: TextStyle(fontSize: 11.0)),
            ],
          ),
        ),
      ],
