...
class LocalUpdateNomineeWithCategoryBlocState extends ChangeNotifier{
...
// Getters
  ...
  removeSocialMediaFromNomineeSocialHandleList(SocialMediaHandle socialMediaHandle){
    nomineeSocialMediaHandle.removeAt(nomineeSocialMediaHandle.indexOf(socialMediaHandle));
    notifyListeners();
  }
